...
<font size="+1"><b>Update the 'books' database.</b></font>

<table border="0" cellspacing="0" cellpadding="5">
<form action="addbookins.cfm" method="post">
<tr>
...
<font size="-1" face="Verdana">name and email you won't see very often and to add a 
book it is not necessary to enter this date. Only for the <a href="cat.cfm?catname=members">Members' favorites</a> these 
information is in any query.<p>
